...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2024 a las 19:00:33
...
(2, 'frank valdez', 'frank@gmail.com', '1234', '', 3, '2024-04-26 19:42:49', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tb_ventas`
  ADD CONSTRAINT `tb_ventas_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `tb_clientes` (`codigo`),
  ADD CONSTRAINT `tb_ventas_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `tb_almacen` (`id_producto`);
COMMIT;
